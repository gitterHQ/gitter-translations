{
	...
	"We asked a few what Gitter means to them, this is what they had to say. If you love Gitter, Tweet us <a %s>%s</a> and we'll update these quotes every month.": "Vi frågade några vad Gitter betyder för dem, detta är deras svar. Om du älskar Gitter, Twittra oss på <a %s>%s</a> så uppdaterar vi dessa citat varje månad.",
	...
	"monthly": "per månad",
	"<b>Unlimited</b> private rooms": "<b>Oändligt</b> privata rum",
	"<b>Unlimited</b> chat history": "<b>Oändlig</b> chatt historik",
	"<b>Purchase</b> now": "<b>Köp</b> nu",
	"Organisation pricing": "Organisationsplaner",
	"Bronze": "Brons",
	"per user/month": "per användare/månad",
	...
	"We currently have apps for OSX, iOS, Android and Windows with a Linux app coming soon. We also have a sweet little <a %s>IRC bridge</a>": "Vi har appar för OSX, iOS, Android och Windows med en Linux app på väg. Vi har också en mysig liten <a %s>IRC brygga</a>",
	"Mac": "Mac",
	"Windows": "Windows",
	...
	"Blog": "Blogg",
	"Twitter": "Twitter",
	"Gitter &mdash; Where developers come to talk.": "Gitter &mdash; Vart utvecklare kommer för att snacka.",
