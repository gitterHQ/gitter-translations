{
	"%d unread message": {
		"one": "%d nieprzeczytana wiadomość",
		"other": "%d nieprzeczytanych wiadomości"
	},
	...
	"Unread messages from %%s, %%s and one other": {
		"one": "Nieprzeczytane wiadomości od %%s, %%s i jeszcze jednej osoby",
		"other": "Nieprzeczytane wiadomości od %%s, %%s i %d innych osób"
	}
}
